...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Factura_prov',
            fields=[
                ('factura', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='app.factura')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('codproducto', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='app.factura_linea_prov')),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.factura_prov'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='factura_prov',
            name='codprov',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.proveedores'),
        ),
        migrations.AddField(
            model_name='factura_linea_prov',
            name='factura_proveedor',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='app.factura_prov'),
        ),
        migrations.AddField(
