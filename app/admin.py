...
admin.site.register(Factura_clie)
admin.site.register(Factura_linea_clie)
admin.site.register(Compra_prov)
admin.site.register(Compra_linea_prov)
admin.site.register(Remision_clie)
admin.site.register(Remision_linea_clie)